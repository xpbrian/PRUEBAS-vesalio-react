...
const Results = ({ lista: datos, filtroMedico, setAsignacion }) => {
...
`
  ...
  const handleClick = async (item) => {
    ...
    let tmp = []
    const response2 = await axios.post(`http://apis-vesalio.com.pe/datosAgendaAll`, { idEspecialidad: null, idPersonal: item.id_usuario, tipo: '02' })
