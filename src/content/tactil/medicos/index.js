...
function ApplicationsespecialidadListaPlatform({setAsignacion}) {
        ...
        <>
            ...
            >
                ...
                <Grid item xs={12} lg={9}>
                    {medicosLista.length > 0 && <Results lista={lista} filtroMedico={filtroMedico} setAsignacion={setAsignacion}/>}
                </Grid>
            </Grid>
            {/* <NewCitaAdmin /> */}
            <DrawerWrapperMobile
