import { Box, Card, Divider, Grid, Zoom } from '@mui/material'
...
export default function Citas({ lista }) {

    const [tabs, setTabs] = useState([{ value: '02', label: 'Por medico', active: true }])
        ...
        <>
            ...
            >
...

                {
                    !sig ? 
                    <Grid item lg={8}>
                        {console.log("casi search2")}
                        holas4<CalendarioAgenda verSacarCita={verSacarCita} tipo={tabs.find(x => x.active).value} agignacionSelecteds={agignacionSelecteds} lista={lista} />
                    </Grid>
                    :
                    <Box>
                        Holas5
