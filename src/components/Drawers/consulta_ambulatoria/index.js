        ...
        const getRpta = async (id) => {
            try {
                ...
                if (res.data.length > 0) {
                    ...
                    setText(res.data[0].datos.text)
                    setDiagnosticos(res.data[0].datos.diagnosticos)
                    setDiagnosticoPrioridad(res.data[0].datos.diagnosticoPrioridad)
                    setRecetas(res.data[0].datos.recetas)
                    setEstudios(res.data[0].datos.estudios)
                    setHospitaliza(res.data[0].datos.hospitaliza)
                    setSelected(res.data[0].datos.selected)
                }
