...
export default function Consulta({
    ...
    const guardarPausa = async () => {
        const rpta = await confirmSweetAlert(`${user.datos.ape_paterno} ${user.datos.ape_materno} ${user.datos.nombres}`, `Esta seguro que desea pausar la consulta`, 'warning', true)
        if (rpta) {
            let obj = {
                vezConsulta,
                mediciones,
